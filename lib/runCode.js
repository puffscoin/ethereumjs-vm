...
This is the core of the PUFFScoin Virtual Machine (EVM or just VM).
 ...
 * @method vm.runCode
 * @param {Object} opts
 * @param {Account} opts.account the [`Account`](https://github.com/puffscoin/puffscoinjs-account) that the executing code belongs to. If omitted an empty account will be used
 ...
 * @param {Block} opts.block the [`Block`](https://github.com/ethereumjs/puffscoinjs-block) the `tx` belongs to. If omitted a blank block will be used
 ...
 * @param {Buffer} opts.value the value in puffs that is being sent to `opt.address`. Defaults to `0`
...
module.exports = function (opts, cb) {
  ...
  function iterateVm (done) {
    ...
    function runStepHook (cb) {
       ...
       * @property {Account} account the [`Account`](https://github.com/puffscoin/puffscoinjs-account) which owns the code running
