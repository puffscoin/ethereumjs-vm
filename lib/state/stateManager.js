...
const { genesisStateByName } = require('puffscoinjs-common/dist/genesisStates')
...
module.exports = class StateManager {
   ...
   * @param {Object} [opts={}]
   * @param {Common} [opts.common] - [`Common`](https://github.com/puffscoin/puffscoinjs-common) parameters of the chain
   * @param {Trie} [opts.trie] - a [`merkle-patricia-tree`](https://github.com/puffscoin/merkle-patricia-tree) instance
   */
  constructor (opts = {}) {
   ...
   * @param {Account} account An [`puffscoinjs-account`](https://github.com/puffscoin/puffscoinjs-account)
   * instance corresponding to the provided `address`
   */

  /**
   * Gets the [`puffscoinjs-account`](https://github.com/puffscoin/puffscoinjs-account)
  ...
  /**
   * Saves an [`puffscoinjs-account`](https://github.com/puffscoin/puffscoinjs-account)
   * into state under the provided `address`
   * @memberof StateManager
   * @method putAccount
   * @param {Buffer} address Address under which to store `account`
   * @param {Account} account The [`puffscoinjs-account`](https://github.com/puffscoin/puffscoinjs-account) to store
