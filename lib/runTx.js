...
/**
 * Process a transaction. Run the vm. Transfers PUFFScoin. Checks balances.
 * @method vm.runTx
 * @param opts
 * @param {Transaction} opts.tx a [`Transaction`](https://github.com/puffscoin/puffscoinjs-tx) to run
 ...
 * @param {BN} results.amountSpent the amount of PUFFScoin used by this transaction as a `bignum`
